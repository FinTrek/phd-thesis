...
\begin{remark}
% \textbf{TODO: This was originally commented out, so check it's all correct and the notation is fine.}
...
\ref{all_pos_prop} we have $c_i = \log a_i$, and in \thrm{Th:24.8a}
...
\begin{remark}\label{Rem:25.8b} \rm The importance of the sign of the row sums of
  $\bfD$, as illustrated by \prop{all_pos_prop}, perplexed us for
...
$I(\theta)$ with Monte Carlo integration. \prop{value_of_I} gives
...
Also, the pdf of $S_n$ can be estimated by numerical inversion of the
...
\section{Remaining steps in the proof of \thrm{Th:24.8a}}
