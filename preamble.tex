...
\newtheorem{test}[subsection]{Test}
...
% \usepackage{graphicx}
% \usepackage{url}
% \usepackage{mathrsfs}      % new calligraphic fonts
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Preamble for the SLP Orthogonal paper
...
\newcommand{\Npos}{\mathbb{N}_+} 
\newcommand{\Z}{\mathbb{Z}} 
\newcommand{\Lp}{L} 
\newcommand{\PGF}{\mathcal{G}} 
\newcommand{\LT}[1]{\mathcal{L}\{#1\}} 
\newcommand{\LTsub}[1]{\mathcal{L}_{#1}} 
